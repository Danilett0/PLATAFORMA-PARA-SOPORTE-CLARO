export const Plantilla = [
  {
    id: 1,
    pregunta: "VISITA (Niveles Desfasados)",
    respuesta:
  ...
  {
    id: 2,
    pregunta: "VISITA (Modem Desenganchado)",
    respuesta:
  ...
  {
    id: 6,
    pregunta: "CONFIGURACIONES AVANZADAS",
    respuesta:
  ...
  {
    id: 8,
    pregunta: "SOLUCION PRIMER CONTACTO",
    respuesta:
